...
const std::string Packages::Cols::_id = "id";
const std::string Packages::Cols::_published_at = "published_at";
const std::string Packages::Cols::_metadata = "metadata";
const std::string Packages::Cols::_name = "name";
const std::string Packages::Cols::_version = "version";
const std::string Packages::Cols::_edition = "edition";
const std::string Packages::Cols::_authors = "authors";
const std::string Packages::Cols::_repository = "repository";
const std::string Packages::Cols::_description = "description";
const std::string Packages::Cols::_license = "license";
const std::string Packages::Cols::_readme = "readme";
const std::string Packages::Cols::_sha256sum = "sha256sum";
const std::string Packages::primaryKeyName = "id";
const bool Packages::hasPrimaryKey = true;
const std::string Packages::tableName = "packages";

const std::vector<typename Packages::MetaData> Packages::metaData_={
...
const std::string &Packages::getColumnName(size_t index) noexcept(false)
{
    assert(index < metaData_.size());
    return metaData_[index].colName_;
}
Packages::Packages(const Row &r, const ssize_t indexOffset) noexcept
{
    if(indexOffset < 0)
    {
        if(!r["id"].isNull())
...
Packages::Packages(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false)
{
...
Packages::Packages(const Json::Value &pJson) noexcept(false)
{
...
void Packages::updateByMasqueradedJson(const Json::Value &pJson,
...
void Packages::updateByJson(const Json::Value &pJson) noexcept(false)
{
    if(pJson.isMember("id"))
    {
        if(!pJson["id"].isNull())
...
const std::string &Packages::getValueOfId() const noexcept
{
...
const std::shared_ptr<std::string> &Packages::getId() const noexcept
{
    return id_;
}
void Packages::setId(const std::string &pId) noexcept
{
    id_ = std::make_shared<std::string>(pId);
    dirtyFlag_[0] = true;
}
void Packages::setId(std::string &&pId) noexcept
{
    id_ = std::make_shared<std::string>(std::move(pId));
    dirtyFlag_[0] = true;
}
const typename Packages::PrimaryKeyType & Packages::getPrimaryKey() const
{
    assert(id_);
    return *id_;
}

const ::trantor::Date &Packages::getValueOfPublishedAt() const noexcept
{
...
const std::shared_ptr<::trantor::Date> &Packages::getPublishedAt() const noexcept
{
    return publishedAt_;
}
void Packages::setPublishedAt(const ::trantor::Date &pPublishedAt) noexcept
{
    publishedAt_ = std::make_shared<::trantor::Date>(pPublishedAt);
    dirtyFlag_[1] = true;
}

const std::string &Packages::getValueOfMetadata() const noexcept
{
    const static std::string defaultValue = std::string();
    if(metadata_)
        return *metadata_;
...
const std::shared_ptr<std::string> &Packages::getMetadata() const noexcept
{
    return metadata_;
}
void Packages::setMetadata(const std::string &pMetadata) noexcept
{
    metadata_ = std::make_shared<std::string>(pMetadata);
    dirtyFlag_[2] = true;
}
void Packages::setMetadata(std::string &&pMetadata) noexcept
{
    metadata_ = std::make_shared<std::string>(std::move(pMetadata));
    dirtyFlag_[2] = true;
}

const std::string &Packages::getValueOfName() const noexcept
{
    const static std::string defaultValue = std::string();
    if(name_)
        return *name_;
...
const std::shared_ptr<std::string> &Packages::getName() const noexcept
{
    return name_;
}
void Packages::setName(const std::string &pName) noexcept
{
    name_ = std::make_shared<std::string>(pName);
    dirtyFlag_[3] = true;
}
void Packages::setName(std::string &&pName) noexcept
{
    name_ = std::make_shared<std::string>(std::move(pName));
    dirtyFlag_[3] = true;
}

const std::string &Packages::getValueOfVersion() const noexcept
{
    const static std::string defaultValue = std::string();
    if(version_)
        return *version_;
...
const std::shared_ptr<std::string> &Packages::getVersion() const noexcept
{
    return version_;
}
void Packages::setVersion(const std::string &pVersion) noexcept
{
    version_ = std::make_shared<std::string>(pVersion);
    dirtyFlag_[4] = true;
}
void Packages::setVersion(std::string &&pVersion) noexcept
{
    version_ = std::make_shared<std::string>(std::move(pVersion));
    dirtyFlag_[4] = true;
}

const short &Packages::getValueOfEdition() const noexcept
{
...
const std::shared_ptr<short> &Packages::getEdition() const noexcept
{
    return edition_;
}
void Packages::setEdition(const short &pEdition) noexcept
{
    edition_ = std::make_shared<short>(pEdition);
    dirtyFlag_[5] = true;
}

const std::string &Packages::getValueOfAuthors() const noexcept
{
    const static std::string defaultValue = std::string();
    if(authors_)
        return *authors_;
...
const std::shared_ptr<std::string> &Packages::getAuthors() const noexcept
{
    return authors_;
}
void Packages::setAuthors(const std::string &pAuthors) noexcept
{
    authors_ = std::make_shared<std::string>(pAuthors);
    dirtyFlag_[6] = true;
}
void Packages::setAuthors(std::string &&pAuthors) noexcept
{
    authors_ = std::make_shared<std::string>(std::move(pAuthors));
    dirtyFlag_[6] = true;
}

const std::string &Packages::getValueOfRepository() const noexcept
{
    const static std::string defaultValue = std::string();
    if(repository_)
        return *repository_;
...
const std::shared_ptr<std::string> &Packages::getRepository() const noexcept
{
    return repository_;
}
void Packages::setRepository(const std::string &pRepository) noexcept
{
    repository_ = std::make_shared<std::string>(pRepository);
    dirtyFlag_[7] = true;
}
void Packages::setRepository(std::string &&pRepository) noexcept
{
    repository_ = std::make_shared<std::string>(std::move(pRepository));
    dirtyFlag_[7] = true;
}

const std::string &Packages::getValueOfDescription() const noexcept
{
    const static std::string defaultValue = std::string();
    if(description_)
        return *description_;
...
const std::shared_ptr<std::string> &Packages::getDescription() const noexcept
{
    return description_;
}
void Packages::setDescription(const std::string &pDescription) noexcept
{
    description_ = std::make_shared<std::string>(pDescription);
    dirtyFlag_[8] = true;
}
void Packages::setDescription(std::string &&pDescription) noexcept
{
    description_ = std::make_shared<std::string>(std::move(pDescription));
    dirtyFlag_[8] = true;
}

const std::string &Packages::getValueOfLicense() const noexcept
{
    const static std::string defaultValue = std::string();
    if(license_)
        return *license_;
...
const std::shared_ptr<std::string> &Packages::getLicense() const noexcept
{
    return license_;
}
void Packages::setLicense(const std::string &pLicense) noexcept
{
    license_ = std::make_shared<std::string>(pLicense);
    dirtyFlag_[9] = true;
}
void Packages::setLicense(std::string &&pLicense) noexcept
{
    license_ = std::make_shared<std::string>(std::move(pLicense));
    dirtyFlag_[9] = true;
}

const std::string &Packages::getValueOfReadme() const noexcept
{
    const static std::string defaultValue = std::string();
    if(readme_)
        return *readme_;
...
const std::shared_ptr<std::string> &Packages::getReadme() const noexcept
{
    return readme_;
}
void Packages::setReadme(const std::string &pReadme) noexcept
{
    readme_ = std::make_shared<std::string>(pReadme);
    dirtyFlag_[10] = true;
}
void Packages::setReadme(std::string &&pReadme) noexcept
{
    readme_ = std::make_shared<std::string>(std::move(pReadme));
    dirtyFlag_[10] = true;
}
void Packages::setReadmeToNull() noexcept
{
    readme_.reset();
    dirtyFlag_[10] = true;
}

const std::string &Packages::getValueOfSha256sum() const noexcept
{
    const static std::string defaultValue = std::string();
    if(sha256sum_)
        return *sha256sum_;
...
const std::shared_ptr<std::string> &Packages::getSha256sum() const noexcept
{
    return sha256sum_;
}
void Packages::setSha256sum(const std::string &pSha256sum) noexcept
{
    sha256sum_ = std::make_shared<std::string>(pSha256sum);
    dirtyFlag_[11] = true;
}
void Packages::setSha256sum(std::string &&pSha256sum) noexcept
{
    sha256sum_ = std::make_shared<std::string>(std::move(pSha256sum));
    dirtyFlag_[11] = true;
}

void Packages::updateId(const uint64_t id)
{
}

const std::vector<std::string> &Packages::insertColumns() noexcept
{
...
void Packages::outputArgs(drogon::orm::internal::SqlBinder &binder) const
{
    if(dirtyFlag_[0])
    {
        if(getId())
...
const std::vector<std::string> Packages::updateColumns() const
{
...
void Packages::updateArgs(drogon::orm::internal::SqlBinder &binder) const
{
    if(dirtyFlag_[0])
    {
        if(getId())
...
Json::Value Packages::toJson() const
{
    Json::Value ret;
    if(getId())
    {
...
Json::Value Packages::toMasqueradedJson(
...
bool Packages::validateJsonForCreation(const Json::Value &pJson, std::string &err)
{
    if(pJson.isMember("id"))
    {
...
bool Packages::validateMasqueradedJsonForCreation(const Json::Value &pJson,
...
bool Packages::validateJsonForUpdate(const Json::Value &pJson, std::string &err)
{
    if(pJson.isMember("id"))
    {
...
bool Packages::validateMasqueradedJsonForUpdate(const Json::Value &pJson,
                                                const std::vector<std::string> &pMasqueradingVector,
                                                std::string &err)
{
    if(pMasqueradingVector.size() != 12)
...
bool Packages::validJsonOfField(size_t index,
